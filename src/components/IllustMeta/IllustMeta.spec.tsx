...
describe('<IllustMeta />', () => {
  ...
  describe('閲覧数・ブックマーク数ともに1以上のとき', () => {
    it('ブックマーク率も表示されること', () => {
      ...
      expect(screen.getByTestId('absoluteTime')).toHaveTextContent('2017年8月30日 00:23');
  ...
  describe('閲覧数1以上・ブックマーク数0のとき', () => {
    it('ブックマーク率は表示されないこと', () => {
      ...
      expect(screen.getByTestId('absoluteTime')).toHaveTextContent('2014年5月15日 18:23');
  ...
  describe('閲覧数・ブックマーク数ともに0のとき', () => {
    it('ブックマーク率は表示されないこと', () => {
      ...
      expect(screen.getByTestId('absoluteTime')).toHaveTextContent('2022年4月3日 23:11');
